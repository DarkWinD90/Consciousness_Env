...
> `Patent_B_Specification_RECONCILED_v2.docx`) are retained as legacy
> reference material and are no longer regenerated. Edit this file
> directly.
...
> claims and figure introduced by Phase 13 (Recurrent Depth). It is part
> of the canonical GitHub specification; no external reconciliation is
> required. The original claims 1–10 above are unchanged.
